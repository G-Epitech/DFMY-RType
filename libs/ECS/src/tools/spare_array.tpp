...
typename sparse_array<Component>::reference_type sparse_array<
    Component>::emplace_at(size_type pos, Params &&... params) {
    ...
    std::allocator_traits<Allocator>::construct(allocator, &_data[pos], std::forward<Params>(params)...);
