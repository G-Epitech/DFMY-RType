...
You can also check out dependency management guide for the **[vcpkg setup](./vcpkg.mdx)**.
...
### 2. Set Up vcpkg
Install vcpkg by following the [official guide](https://github.com/microsoft/vcpkg#quick-start), then integrate it with CMake. Run the following command:
```
