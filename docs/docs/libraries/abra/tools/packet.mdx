...
The constants values are defined in `header.hpp` but you can also find documentation about bits allocation in **[Network Protocol - Header](/docs/network/network-protocol#header)**.
