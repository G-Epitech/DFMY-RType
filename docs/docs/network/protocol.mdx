...
- Multi package identification (Multiple packets can have the same ID with a different offset)
...
The last byte is hight if the package is the last in the list.
