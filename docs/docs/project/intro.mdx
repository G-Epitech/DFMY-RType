...
2. Install the game on your platform. Follow the [instructions here](./install) to install the game on your platform.

3. Play the game and enjoy the experience. Find out more about the game [here](./game).
