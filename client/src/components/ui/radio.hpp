...
struct Radio {
  ...
  struct Utils {
     ...
     */
    static ValueType GetValue(const zygarde::tools::sparse_array<Radio>::ptr &radios,
                              const std::string &id);
     ...
     */
    static ValueType SetValue(const zygarde::tools::sparse_array<Radio>::ptr &radios,
                              const std::string &id, const ValueType &value);
  };
